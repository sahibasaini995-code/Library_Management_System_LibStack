...
public class BookService {
    ...
    return BookRepository.findByStatus("issued");
}
public Book unissueBook(String bookId) {
...
//    }
    ...
    public Book issueBook(String bookId, String userId, java.util.Date issueDate, java.util.Date expectedReturnDate) {
        Optional<Book> optionalBook = BookRepository.findBooksByBookId(bookId);
        if (!optionalBook.isEmpty()) {
            Book book = optionalBook.get();
